...
func TestMarkdownRendersCoreStructures(t *testing.T) {
	...
	for _, want := range []string{`<h1 id="title">Title</h1>`, `<code>code</code>`, `<li>one</li>`, `rlviz demo`} {
...
func TestBuildWritesEveryPageAndStylesheet(t *testing.T) {
	...
	for _, name := range []string{
		"index.html", "index.md", "readme.html", "readme.md", "product-spec.html", "product-spec.md",
		"interaction-spec.html", "interaction-spec.md", "onboarding.html", "onboarding.md",
		"adapter-authoring.html", "adapter-authoring.md", "llms.txt", "llms-full.txt", "CNAME", "style.css",
	} {
