...
export const commandIds = {
  workspace: {
    ...
    descend: "workspace.descend", ascend: "workspace.ascend", openDetail: "workspace.openDetail", toggleDetailPin: "workspace.toggleDetailPin", toggleDetailCompact: "workspace.toggleDetailCompact", toggleSpotlight: "workspace.toggleSpotlight", toggleGuide: "workspace.toggleGuide", toggleSettings: "workspace.toggleSettings", reset: "workspace.reset", jumpBack: "workspace.jumpBack", jumpForward: "workspace.jumpForward", resizeMode: "workspace.resizeMode", moveMode: "workspace.moveMode",
  },
  trajectory: {
...
export const commands: readonly CommandDefinition[] = [
  ...
  { id: commandIds.workspace.descend, scope: "workspace", label: "Open selected section", defaultBindings: ["Enter", "Space"] },
  { id: commandIds.workspace.ascend, scope: "workspace", label: "Ascend active lane or restore arrangement", defaultBindings: ["Escape"] },
  { id: commandIds.workspace.openDetail, scope: "workspace", label: "Open or close rollout detail", defaultBindings: ["d"] },
  { id: commandIds.workspace.toggleDetailPin, scope: "workspace", label: "Pin or unpin detail", defaultBindings: ["Shift+D"] },
  { id: commandIds.workspace.toggleDetailCompact, scope: "workspace", label: "Compact or expand detail", defaultBindings: ["Shift+C"] },
  ...
  { id: commandIds.workspace.moveMode, scope: "workspace", label: "Toggle module move mode", defaultBindings: ["Ctrl+m"] },
